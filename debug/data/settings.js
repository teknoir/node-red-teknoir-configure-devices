  ...
  editorTheme: {
    ...
    palette: {
      ...
      catalogues: [
        ...
        "https://raw.githubusercontent.com/teknoir/devstudio-catalog/main/catalogue.json",
      ],
      theme: [
    ...
    page: {
      ...
      favicon: path.join(__dirname, "theme/public/images/favicon.png"),
    ...
    header: {
      title: " ",
      image: path.join(__dirname, "theme/public/images/header_logo.svg"), // or null to remove image
      url: "https://teknoir.cloud/", // optional url to make the header text/image a link to this url
    },
    deployButton: {
      type: "simple",
      label: "Deploy",
